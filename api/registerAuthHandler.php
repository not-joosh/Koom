<?php 
    ...
    switch($method) {
        ...
        case 'POST':
            ...
            $stmt = $pdo->prepare("INSERT INTO user (first_name, last_name, middle_name, address, city, barangay, province, email, contact_number, password, account_type, usc_id_num, last_checkin_time, last_checkin_date) 
